...
#*********************************************************************************************************
#*********************************************************************************************************
# libgooglepinyin src(s) file
#*********************************************************************************************************
LIB_SRCS = \
libgooglepinyin/src/dictbuilder.c \
libgooglepinyin/src/dictlist.c \
libgooglepinyin/src/dicttrie.c \
libgooglepinyin/src/lpicache.c \
libgooglepinyin/src/matrixsearch.c \
libgooglepinyin/src/mystdlib.c \
libgooglepinyin/src/ngram.c \
libgooglepinyin/src/pinyinime.c \
libgooglepinyin/src/searchutility.c \
libgooglepinyin/src/spellingtable.c \
libgooglepinyin/src/spellingtrie.c \
libgooglepinyin/src/splparser.c \
libgooglepinyin/src/sync.c \
libgooglepinyin/src/userdict.c \
libgooglepinyin/src/utf16char.c \
libgooglepinyin/src/utf16reader.c

#*********************************************************************************************************
# dictbuilder src(s) file
#*********************************************************************************************************
EXE_SRCS = \
libgooglepinyin/tools/pinyinime_dictbuilder.c 
...
#  target
#*********************************************************************************************************
LIB = $(OUTPATH)/libgooglepinyin.a
DLL = $(OUTPATH)/libgooglepinyin.so
EXE = $(OUTPATH)/dictbuilder

#*********************************************************************************************************
# libgooglepinyin objects
#*********************************************************************************************************
...
#*********************************************************************************************************
DEPEND_DLL = -lcextern
EXE_DEPEND_DLL = -lgooglepinyin -lcextern -lvpmpdm
...
#*********************************************************************************************************
# link libgooglepinyin.a object files
#*********************************************************************************************************
$(LIB): $(LIB_OBJS)
		$(AR) $(ARFLAGS) $(LIB) $(LIB_OBJS)

#*********************************************************************************************************
# link libgooglepinyin.so object files
#*********************************************************************************************************
$(DLL): $(LIB_OBJS)
